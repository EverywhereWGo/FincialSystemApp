 ...
 * 用于处理预算相关的API响应转换
 */
public class BudgetResponseConverter extends Converter.Factory {
    private static final String TAG = "BudgetConverter";
    private final Gson gson;

    private BudgetResponseConverter(Gson gson) {
        this.gson = gson;
    }

    public static BudgetResponseConverter create() {
        return create(new Gson());
    }

    public static BudgetResponseConverter create(Gson gson) {
        return new BudgetResponseConverter(gson);
    }
